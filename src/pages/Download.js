        ...
        <section className="apps-seciton padding-top pt-lg-0">
          <div className="container">
            <div className="apps-wrapper bg-six padding-top padding-bottom">
              <div
                className="bg_img apps-bg"
                data-background="assets/images/apps/apps01.png"
              />
              ...
              <div className="row">
                <div className="col-lg-7 offset-lg-5">
                  <div className="content">
                    ...
                    <p>
                      As the largest mobile platform in the country, we have the
                      right services, the know-how and the expertise to make
                      your buying transition to mobile simple, easy and
                      painless.
                    </p>
          ...
          <div className="container">
            <div className="section-header-3">
              ...
              <p>
                ...
                neque est, aliquam eu dignissim eget, eleifend at nunc.
                Curabitur non dapibus nulla.
              </p>
            </div>
